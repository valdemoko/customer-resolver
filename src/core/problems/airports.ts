...
const AIRPORTS: readonly AirportEntry[] = [
  ...
  },
  {
    ...
    lat: 41.2974,
    lon: 2.0833,
    aliases: ["barcelona", "el prat", "barcelona el prat", "josep tarradellas"],
  },
  ...
  { code: "AGP", lat: 36.6749, lon: -4.4991, aliases: ["malaga", "costa del sol"] },
  {
    ...
    lat: 39.5517,
    lon: 2.7388,
    aliases: ["palma", "palma de mallorca", "mallorca", "son sant joan"],
  },
  { code: "IBZ", lat: 38.8729, lon: 1.3731, aliases: ["ibiza", "eivissa"] },
  {
    ...
    lat: 27.9319,
    lon: -15.3866,
    aliases: ["gran canaria", "las palmas", "las palmas de gran canaria"],
  },
  {
    code: "TFN",
    lat: 28.4827,
    lon: -16.3415,
    aliases: ["tenerife norte", "tenerife", "los rodeos"],
  },
  {
    code: "TFS",
    lat: 28.0443,
    lon: -16.5725,
    aliases: ["tenerife sur", "tenerife sur reina sofia"],
  },
  { code: "ACE", lat: 28.9455, lon: -13.6052, aliases: ["lanzarote", "arrecife"] },
  {
    ...
    lat: 28.4527,
    lon: -13.8638,
    aliases: ["fuerteventura", "el mattoral", "puerto del rosario"],
  },
  { code: "BIO", lat: 43.3011, lon: -2.9106, aliases: ["bilbao", "lujua", "sondika"] },
  {
    ...
    lat: 42.8963,
    lon: -8.4151,
    aliases: ["santiago", "santiago de compostela", "lavacolla"],
  },
  ...
  { code: "GRX", lat: 37.1887, lon: -3.7774, aliases: ["granada", "granada jaen"] },
  {
    ...
    lat: 36.7446,
    lon: -6.0601,
    aliases: ["jerez", "jerez de la frontera", "la parra"],
  },
  {
    code: "ALC",
    lat: 38.2822,
    lon: -0.5582,
    aliases: ["alicante", "elche", "el altet", "alicante elche"],
  },
  {
    code: "RMU",
    lat: 37.803,
    lon: -1.1252,
    aliases: ["murcia", "corvera", "murcia corvera", "san javier"],
  },
  ...
  { code: "LEI", lat: 36.8439, lon: -2.3701, aliases: ["almeria"] },
  {
    ...
    lat: 43.3021,
    lon: -8.3772,
    aliases: ["a coruna", "coruna", "la coruna", "alvedro"],
  },
  ...
  // ── Europa ────────────────────────────────────────────────────────
  {
    ...
    lat: 49.0097,
    lon: 2.5479,
    aliases: ["paris", "paris charles de gaulle", "charles de gaulle", "roissy"],
  },
  { code: "ORY", lat: 48.7262, lon: 2.3652, aliases: ["paris orly", "orly"] },
  {
    ...
    lat: 41.8003,
    lon: 12.2389,
    aliases: ["roma", "rome", "fiumicino", "roma fiumicino"],
  },
  ...
  { code: "BER", lat: 52.3667, lon: 13.5033, aliases: ["berlin", "berlin brandeburgo"] },
  {
    ...
    lat: 52.3105,
    lon: 4.7683,
    aliases: ["amsterdam", "schiphol", "amsterdam schiphol"],
  },
  {
    code: "LHR",
    lat: 51.47,
    lon: -0.4543,
    aliases: ["londres", "london", "heathrow", "londres heathrow"],
  },
  ...
  { code: "LIS", lat: 38.7756, lon: -9.1354, aliases: ["lisboa", "lisbon"] },
  {
    ...
    lat: 41.2481,
    lon: -8.6814,
    aliases: ["oporto", "porto", "francisco sa carneiro"],
  },
  ...
  { code: "DUB", lat: 53.4264, lon: -6.2499, aliases: ["dublin"] },
  {
    ...
    lat: 37.9364,
    lon: 23.9475,
    aliases: ["atenas", "athens", "eleftherios venizelos"],
  },
  {
    code: "WAW",
    lat: 52.1657,
    lon: 20.9671,
    aliases: ["varsovia", "warsaw", "warszawa", "chopin"],
  },
  ...
  // ── Latinoamérica y largo radio ───────────────────────────────────
  {
    ...
    lat: 40.6413,
    lon: -73.7781,
    aliases: ["nueva york", "new york", "john f kennedy"],
  },
  ...
  { code: "YYZ", lat: 43.6777, lon: -79.6248, aliases: ["toronto", "pearson"] },
  {
    ...
    lat: 19.4363,
    lon: -99.0721,
    aliases: ["ciudad de mexico", "mexico df", "benito juarez"],
  },
  ...
  { code: "EZE", lat: -34.8222, lon: -58.5358, aliases: ["buenos aires", "ezeiza"] },
  {
    ...
    lat: -33.393,
    lon: -70.7858,
    aliases: ["santiago de chile", "arturo merino benitez"],
  },
