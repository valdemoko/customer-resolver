 ...
 * Resolveo — Logo mark.
 *
 * Link icon representing connection between consumer problems and solutions.
 */
...
const sizeConfig = {
  sm: { icon: "w-5 h-5", text: "text-[28px]", gap: "gap-2" },
  md: { icon: "w-6 h-6", text: "text-lg", gap: "gap-2.5" },
  lg: { icon: "w-8 h-8", text: "text-xl", gap: "gap-3" },
} as const;
